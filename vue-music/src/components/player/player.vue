  ...
  <div class="player" v-show="playList.length>0">
    ...
    >
      <div class="normal-layer" v-show="fullScreen">
        ...
        <div class="middle" @touchstart="touchMiddleStart"
  ...
  export default {
    ...
    methods: {
      ...
      format (time) {
        ...
        let seconds = this._pad(time % 60, 2)
        return `${minutes}:${seconds}`
      },
      precentChange (newPrecent) {
        const time = this.currentSong.duration * newPrecent
      ...
      touchMiddleMove (e) {
        ...
        const offsetWidth = Math.min(Math.max(left + deltX, -window.innerWidth), 0)
